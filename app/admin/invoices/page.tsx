  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4 md:mb-6">
        ...
        <Link
          href="/admin/invoices/reporting"
          className="flex items-center gap-2 px-4 py-2 bg-primary-green text-white rounded-lg hover:bg-primary-dark-green transition text-sm font-medium"
        >
